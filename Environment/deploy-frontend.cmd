call az storage blob upload-batch -s %1 -d $web --account-name %2 --auth-mode login
call az storage blob service-properties update --account-name %2 --static-website --index-document index.html --404-document index.html --auth-mode login
